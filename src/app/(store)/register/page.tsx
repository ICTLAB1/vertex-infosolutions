...
export const metadata: Metadata = {
  ...
  description:
    "Create a Vertex Infosolutions account. Your licensed products and subscriptions are delivered into it and stay there.",
  ...NOINDEX,
};
    ...
    <div className="mx-auto max-w-[440px] px-4 py-10">
      <div className="rounded-lg border border-line bg-surface p-6">
        ...
        <p className="mt-1 mb-4 text-[14px] text-muted">
          ...
          licences, invoices and renewal dates in one place, so nothing depends
          on finding an old email.
        </p>
        <RegisterForm />
      </div>
    </div>
